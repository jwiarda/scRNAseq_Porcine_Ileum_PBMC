---
title: "Reference-based Label Prediction and Mapping of Porcine Ileal Cells: Creation of Murinized Porcine Ileum Query Datasets"
author: "Jayne Wiarda"
date: "5Apr2021"
output: 
  github_document: 
...
In this analysis, we create query datasets that can be compared directly to other murine scRNA-seq reference datasets (query_SsIleum_Wiarda_murinized).
...
## Create murinized porcine ileum query datasets
...
dim(SsIleum_Wiardagenes)
# [1] 17438     1
pigGenes <- read.delim("/Users/jayne.wiarda/Desktop/scRNAseq/UnfilteredGeneInfo_v97reference.txt", header = TRUE, sep = " ") # read in unfiltered gene info
...
rownames(SsIleum_Wiardacounts) <- SsIleum_Wiardanames$Mouse.gene.name # change pig genes to Mouse gene names
...
```{r, warning = FALSE, error = FALSE}
saveRDS(SsIleum_Wiarda.list, '/Users/jayne.wiarda/Desktop/scRNAseq/scRNAseqIleumAtlas/Ileum/QueryData/query_SsIleum_Wiarda_murinized.rds')
```
