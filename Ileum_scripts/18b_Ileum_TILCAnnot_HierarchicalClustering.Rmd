...
We have now created our final annotations for our T/ILC data and need to re-do overall hierarchical clustering with these final annotations.
...
Idents(ilT) <- ilT$cellID # change our default IDs to our cluster assignments
```
...
```{r, warning = FALSE, error = FALSE, fig.width = 20}
data.tree <- ape::rotateConstr(data.tree, rev(c('Cycling CD4 ab T cells', 
                                            'Cycling CD8 ab T cells', 'Cycling gd T cells', 'Cycling group 1 ILCs', 'Cytotoxic CD8 ab T cells', 'Cytotoxic gd T cells', 'Cytotoxic group 1 ILCs', 'Activated CD8 ab T cells', 'Activated gd T cells', 'Activated group 1 ILCs','SELLhi gd T cells', 'CD2neg GD T cells', 'Naive CD4/CD8 ab T cells', 'Activated CD4 ab T cells', 'Follicular CD4 ab T cells', 'Group 3 ILCs')))
...
```{r, warning = FALSE, error = FALSE}
levels(ilT) <- c('Cycling CD4 ab T cells', 
                                            'Cycling CD8 ab T cells', 'Cycling gd T cells', 'Cycling group 1 ILCs', 'Cytotoxic CD8 ab T cells', 'Cytotoxic gd T cells', 'Cytotoxic group 1 ILCs', 'Activated CD8 ab T cells', 'Activated gd T cells', 'Activated group 1 ILCs','SELLhi gd T cells', 'CD2neg GD T cells', 'Naive CD4/CD8 ab T cells', 'Activated CD4 ab T cells', 'Follicular CD4 ab T cells', 'Group 3 ILCs')
ilT$phylo <- Idents(ilT)
```
