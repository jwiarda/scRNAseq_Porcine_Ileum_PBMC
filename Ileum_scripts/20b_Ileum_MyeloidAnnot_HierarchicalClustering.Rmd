---
title: "Characterization of Ileal Myeloid Cells: Hierarchical Clustering"
author: "Jayne Wiarda"
date: "21June2021"
output: 
  github_document: 
...
We have now created our final annotations for our myeloid data and need to re-do overall hierarchical clustering with these final annotations.
...
Idents(ilM) <- ilM$cellID # change our default IDs to our cluster assignments
```
...
```{r, warning = FALSE, error = FALSE, fig.width = 20}
data.tree <- ape::rotateConstr(data.tree, c('Dendritic cells', 'Macrophages', 'Mast cells'))
