---
title: "Characterization of Ileal Non-immune Cells: Overall Differential Gene Expression (DGE) Analysis"
author: "Jayne Wiarda"
date: "21June2021"
output: 
  github_document: 
...
We have now created our final annotations for our data and need to re-do overall DGE analysis with these final annotations for only non-immune cells.
...
write.table(ilDE, 
            file = "/home/Jayne.Wiarda/scRNAseqIleumAtlas/Ileum/DE/NonImmune_FINALannot_OverallDE.txt") 
write_xlsx(x = ilDE, 
           path = "/home/Jayne.Wiarda/scRNAseqIleumAtlas/Ileum/DE/NonImmune_FINALannot_OverallDE.xlsx",
           col_names = TRUE)
```
