...
```{r}
sc = load10X('/home/Jayne.Wiarda/scRNAseqIleumAtlas/CellRanger/IPP1/') 
```
...
#### Provide file path to Cell Ranger outputs:
```{r}
sc = load10X('/home/Jayne.Wiarda/scRNAseqIleumAtlas/CellRanger/IPP2/') 
```
...
#### Provide file path to Cell Ranger outputs:
```{r}
sc = load10X('/home/Jayne.Wiarda/scRNAseqIleumAtlas/CellRanger/NoPP1/') 
```
...
#### Provide file path to Cell Ranger outputs:
```{r}
sc = load10X('/home/Jayne.Wiarda/scRNAseqIleumAtlas/CellRanger/NoPP2/') 
```
...
#### Provide file path to Cell Ranger outputs:
```{r}
sc = load10X('/home/Jayne.Wiarda/scRNAseqIleumAtlas/CellRanger/X2I1/') 
```
...
#### Provide file path to Cell Ranger outputs:
```{r}
sc = load10X('/home/Jayne.Wiarda/scRNAseqIleumAtlas/CellRanger/X2I2/') 
```
