---
title: "Characterization of Ileal B Cells: Overall Differential Gene Expression (DGE) Analysis"
author: "Jayne Wiarda"
date: "21June2021"
output: 
  github_document: 
...
We have now created our final annotations for our data and need to re-do overall DGE analysis with these final annotations for only B cells.
...
il <- readRDS("/home/Jayne.Wiarda/scRNAseqIleumAtlas/Ileum/Seurat/Ileum_Bonly.rds") 
DefaultAssay(il) <- "RNA"
...
write.table(ilDE, 
            file = "/home/Jayne.Wiarda/scRNAseqIleumAtlas/Ileum/DE/B_FINALannot_OverallDE.txt") 
write_xlsx(x = ilDE, 
           path = "/home/Jayne.Wiarda/scRNAseqIleumAtlas/Ileum/DE/B_FINALannot_OverallDE.xlsx",
           col_names = TRUE)
```
