---
title: "Characterization of B Lineage Lymphocytes: Visualizing Prediction & Mapping Results"
author: "Jayne Wiarda"
date: "15Apr2021"
output: 
  github_document: 
...
We have now created a data subset consisting of only B Lineage Lymphocytes. Let's now overlay preference-based prediction & mapping information back onto our Non-leukocyte data.
...
We selected and plotted overlaid prediction scores for B Lineage Lymphocyte populations found in reference data.

From murine ileum reference cell types:

```{r, warning = FALSE, error = FALSE, fig.width = 15, message = FALSE, fig.height = 7}
FeaturePlot(ilB, 
            features = c('MmIleum_CellType_prediction.score.GC.B.cell..DZ.',
...
FeaturePlot(ilB, 
            features = c('HsIleum_CellType_prediction.score.IgA.plasma.cell',
...
```{r, warning = FALSE, error = FALSE, fig.width = 15, message = FALSE, fig.height = 7}
FeaturePlot(ilB, 
            features = c('SsPBMC_CellType_prediction.score.Antibody.secreting.cells',
