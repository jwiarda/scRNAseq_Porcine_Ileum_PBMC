---
title: "Characterization of Ileal B Lineage Lymphocytes: Hierarchical Clustering"
author: "Jayne Wiarda"
date: "11Apr2021"
output: 
  github_document: 
...
We have now created a data subset consisting of only B lineage lymphocytes. Let's now perform hierarchical clustering analysis on just these clusters of cells.
...
```{r, warning = FALSE, error = FALSE}
levels(ilB) <- rev(c('33', '25', '9', '13', '30', '8', '5', '40', '39', '22', '16',
                     '48', '28', '2', '38', '27', '20', '10', '4', '0', '21', '11')) 
ilB$phyloorder <- Idents(ilB)
```
