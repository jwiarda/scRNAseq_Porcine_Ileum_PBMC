---
title: "Characterization of Ileal GD & CD8 AB T Cells: Hierarchical Clustering"
author: "Jayne Wiarda"
date: "15Apr2021"
output: 
  github_document: 
...
We have now created a data subset consisting of only GD & CD8 AB T Cells. Let's now perform hierarchical clustering analysis on just these clusters of cells.
...
DefaultAssay(ilgdCD8T) <- "RNA" # set our default assay to RNA for subsequent work
Idents(ilgdCD8T) <- ilgdCD8T$seurat_clusters # change our default IDs to our cluster assignments
```
...
```{r, warning = FALSE, error = FALSE}
ilgdCD8T <- BuildClusterTree(ilgdCD8T, 
                       dims = PCdims, 
                       assay = "PCA")
```
...
```{r, warning = FALSE, error = FALSE, fig.width = 20}
data.tree <- Tool(object = ilgdCD8T, 
...
```{r, warning = FALSE, error = FALSE}
levels(ilgdCD8T) <- rev(c('51', '32', '35', '23', '37', '3', '14', 
                          '19', '47', '17', '7', '34', '6', '29', '31')) 
ilgdCD8T$phyloorder <- Idents(ilgdCD8T)
```
...
saveRDS(ilgdCD8T, "/home/Jayne.Wiarda/scRNAseqIleumAtlas/Ileum/Seurat/Ileum_gdCD8Tonly.rds")
```
