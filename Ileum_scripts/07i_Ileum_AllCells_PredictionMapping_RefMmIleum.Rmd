---
title: "Reference-based Label Prediction and Mapping of Porcine Ileal Cells to Murine Ileum"
author: "Jayne Wiarda"
date: "7Apr2021"
output: 
  github_document: 
...
* A scRNA-seq dataset cataloging porcine PBMCs (Herrera-Uribe & Wiarda et al. 2021); referred to as MmIleum_Xu) 
...
* A scRNA-seq dataset cataloging cells from human terminal ileum (Elmentaite et al. 2020; referred to as MmIleum_Xu)
...
In this analysis, we finally perform reference-based label prediction and mapping of our porcine ileum scRNA-seq data and a reference dataset of murine ileum.
...
ref <- readRDS('/Users/jayne.wiarda/Desktop/scRNAseq/scRNAseqIleumAtlas/Ileum/ReferenceData/Xu_MmIleum/reference_MmIleum_Xu.rds') 
...
```{r, warning = FALSE, error = FALSE}
query <- readRDS('/Users/jayne.wiarda/Desktop/scRNAseq/scRNAseqIleumAtlas/Ileum/QueryData/query_SsIleum_Wiarda_murinized.rds')
...
for(i in 1:length(query)) {
  ...
  predictions <- TransferData(anchorset = anchors, 
                              refdata = list(cell_lineage = ref$cellLineage, 
                                             cell_type = ref$cellType), # predict query dataset IDs at level of reference data's cluster, lineage, and cell type classifications
                              dims = 1:30,
...
write_xlsx(MappingScores, '/Users/jayne.wiarda/Desktop/scRNAseq/scRNAseqIleumAtlas/Ileum/MappingResults/MmIleum_Xu_MappingScores.xlsx')
write_xlsx(CellLineagePredictions, '/Users/jayne.wiarda/Desktop/scRNAseq/scRNAseqIleumAtlas/Ileum/MappingResults/MmIleum_Xu_CellLineagePredictions.xlsx')
write_xlsx(CellTypePredictions, '/Users/jayne.wiarda/Desktop/scRNAseq/scRNAseqIleumAtlas/Ileum/MappingResults/MmIleum_Xu_CellTypePredictions.xlsx')
write_xlsx(MasterMeta, '/Users/jayne.wiarda/Desktop/scRNAseq/scRNAseqIleumAtlas/Ileum/MappingResults/MmIleum_Xu_MasterMeta_PredictionMapping.xlsx')
```
