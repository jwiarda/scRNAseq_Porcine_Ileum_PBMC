---
title: "Characterization of Ileal Myeloid Lineage Leukocytes: Hierarchical Clustering"
author: "Jayne Wiarda"
date: "10Apr2021"
output: 
  github_document: 
...
We have now created a data subset consisting of only myeloid lineage leukocytes. Let's now perform hierarchical clustering analysis on just these clusters of cells.
...
```{r, warning = FALSE, error = FALSE, fig.width = 20}
data.tree <- ape::rotateConstr(data.tree, c('52', '49', '42'))
...
```{r, warning = FALSE, error = FALSE}
levels(ilM) <- rev(c('52', '49', '42')) 
ilM$phyloorder <- Idents(ilM)
```
