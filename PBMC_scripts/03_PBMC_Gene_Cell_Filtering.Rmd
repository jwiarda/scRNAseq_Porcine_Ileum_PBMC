...
We will be removing genes that were not expressed in any of the cells of our PBMC scRNA-seq samples. In addition, we will be removing cells that are of poor quality, as indicated by a high percentage of mitochondrial genes, low number of total genes detected, and/or low number of unique molecular identifiers (UMIs) detected in a cell, mirroring thresholds used for ileum scRNA-seq analysis. In this step, we get to know the quality of our data by plotting various parameters and choosing appropriate cell filtering thresholds accordingly. We also output several gene lists that will be useful for future analyses.
...
data_dir <- c(PBMC1 = "/home/Jayne.Wiarda/scRNAseqIleumAtlas/PBMC/SoupX/PBMC1strainedCounts",
              PBMC2 = "/home/Jayne.Wiarda/scRNAseqIleumAtlas/PBMC/SoupX/PBMC2strainedCounts")
library_id <- c("PBMC1", "PBMC2") 
...
saveRDS(out,file=file.path("/home/Jayne.Wiarda/scRNAseqIleumAtlas/PBMC/QC/", "PBMC_QC.rds")) # this saves all of our information before filtering out low quality cells
write.table(fDat, 
            file = "/home/Jayne.Wiarda/scRNAseqIleumAtlas/PBMC/QC/GeneInfo.txt") # export the feature information separately...this will come in handy later
write_xlsx(x = fDat, 
           path = "/home/Jayne.Wiarda/scRNAseqIleumAtlas/PBMC/QC/GeneInfo.xlsx", # export the feature information separately...this will come in handy later
           col_names = TRUE) # this is the file used for cluster-specific cell type 
write.table(ssc_genes, 
            file = "/home/Jayne.Wiarda/scRNAseqIleumAtlas/PBMC/QC/UnfilteredGeneInfo.txt") # export the feature information separately...this will come in handy later
write_xlsx(x = ssc_genes, 
           path = "/home/Jayne.Wiarda/scRNAseqIleumAtlas/PBMC/QC/UnfilteredGeneInfo.xlsx", # export the feature information separately...this will come in handy later
           col_names = TRUE) # this is the file used for cluster-specific cell type 
```
...
PBMC1 <- subset(All, ident = "PBMC1") 
PBMC2 <- subset(All, ident = "PBMC2")
```

Save filtered data for each sample:

```{r, warning = FALSE, error = FALSE, eval = TRUE}
write10xCounts(x = PBMC1@assays$RNA@counts, path = "/home/Jayne.Wiarda/scRNAseqIleumAtlas/PBMC/QC/PBMC1onlyFilteredQC", version = "3") 
write10xCounts(x = PBMC2@assays$RNA@counts, path = "/home/Jayne.Wiarda/scRNAseqIleumAtlas/PBMC/QC/PBMC2onlyFilteredQC", version = "3")
```
