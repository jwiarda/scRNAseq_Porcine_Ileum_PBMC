---
title: "Removal of Ambient RNA from PBMC scRNA-seq Samples"
author: "Jayne Wiarda"
date: "2Apr2021"
output:
  github_document: 
...
```{r}
sc = load10X('/home/Jayne.Wiarda/scRNAseqIleumAtlas/PBMC/CellRanger/PBMC1/') 
```
...
write10xCounts("/home/Jayne.Wiarda/scRNAseqIleumAtlas/PBMC/SoupX/PBMC1strainedCounts", out, version = "3")
...
#### Provide file path to Cell Ranger outputs:
```{r}
sc = load10X('/home/Jayne.Wiarda/scRNAseqIleumAtlas/PBMC/CellRanger/PBMC2/') 
```
...
#### Save our strained count matrix to a new location:
```{r, warning = FALSE, error = FALSE, eval = FALSE}
write10xCounts("/home/Jayne.Wiarda/scRNAseqIleumAtlas/PBMC/SoupX/PBMC2strainedCounts", out, version = "3")
rm(dd, gg, mids, out, sc, cntSoggy, cntStrained)
```
