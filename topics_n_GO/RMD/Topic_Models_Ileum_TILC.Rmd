---
title: "Ileum T-ILC Cells - Topic Model Exploration"
...
SEURAT <- read_rds('./data/Ileum_TILConly.rds')
FITS <- read_rds('./topic_model_fits/Ileum_TILConly_K_3_K_10_topic_model_fits.rds')
GROUP <- 'Ileum_TILC' # probably can find a way to cut this
