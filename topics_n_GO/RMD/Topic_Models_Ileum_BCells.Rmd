---
title: "Ileum B Cells - Topic Model Exploration"
...
SEURAT <- read_rds('./data/Ileum_Bonly.rds')
FITS <- read_rds('./topic_model_fits/Ileum_Bonly_K_3_K_10_topic_model_fits.rds')
GROUP <- 'Ileum_Bonly'
