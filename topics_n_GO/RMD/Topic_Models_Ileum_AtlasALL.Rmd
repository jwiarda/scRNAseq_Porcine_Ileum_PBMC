---
title: "Ileum: All Cells - Topic Model Exploration"
...
SEURAT <- read_rds('./data/IleumAtlasAll.rds')
FITS <- read_rds('./topic_model_fits/IleumAtlasAll_K_3_K_10_topic_model_fits.rds')
GROUP <- 'Ileum_ALL' # probably can find a way to cut this
