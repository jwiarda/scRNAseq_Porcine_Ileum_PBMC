---
title: "Ileum gdCD8 T Cells - Topic Model Exploration"
...
SEURAT <- read_rds('./data/Ileum_gdCD8Tonly.rds')
FITS <- read_rds('./topic_model_fits/Ileum_gdCD8Tonly_K_3_K_10_topic_model_fits.rds')
GROUP <- 'Ileum_gdCD8' # probably can find a way to cut this
