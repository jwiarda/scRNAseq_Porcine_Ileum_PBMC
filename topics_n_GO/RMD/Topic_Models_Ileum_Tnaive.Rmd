---
title: "Ileum Naive T Cells - Topic Model Exploration"
...
SEURAT <- read_rds('./data/Ileum_TnaiveOnly.rds')
FITS <- read_rds('./topic_model_fits/Ileum_TnaiveOnly_K_3_K_10_topic_model_fits.rds')
GROUP <- 'Ileum_Tnaive' # probably can find a way to cut this
