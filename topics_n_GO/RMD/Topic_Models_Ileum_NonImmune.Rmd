---
title: "Ileum Non-Immune Cells - Topic Model Exploration"
...
SEURAT <- read_rds('./data/Ileum_NonImmuneOnly.rds')
FITS <- read_rds('./topic_model_fits/Ileum_NonImmuneOnly_K_3_K_10_topic_model_fits.rds')
GROUP <- 'Ileum_NonImmune' # probably can find a way to cut this
