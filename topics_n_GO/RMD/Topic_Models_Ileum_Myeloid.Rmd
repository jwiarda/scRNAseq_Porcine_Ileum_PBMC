---
title: "Ileum Myeloid Cells - Topic Model Exploration"
...
SEURAT <- read_rds('./data/Ileum_MyeloidOnly.rds')
FITS <- read_rds('./topic_model_fits/Ileum_MyeloidOnly_K_3_K_10_topic_model_fits.rds')
GROUP <- 'Ileum_Myeloid' # probably can find a way to cut this
