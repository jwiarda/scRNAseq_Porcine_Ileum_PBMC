---
title: "Ileum ILCs - Topic Model Exploration"
...
SEURAT <- read_rds('./data/Ileum_ILConly.rds')
FITS <- read_rds('./topic_model_fits/Ileum_ILConly_K_3_K_10_topic_model_fits.rds')
GROUP <- 'Ileum_ILC' # probably can find a way to cut this
